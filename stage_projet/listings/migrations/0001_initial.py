    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datesortie', models.DateTimeField(default=datetime.datetime.now)),
                ...
                ('Personnel_soignant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='listings.personnel_soignant')),
            ],
        ),
        migrations.CreateModel(
            name='Service',
        ...
        migrations.AddField(
            model_name='personnel_soignant',
            name='Type_personnel_soignant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='listings.type_personnel_soignant'),
        ),
        migrations.CreateModel(
            name='Patient',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('refpersoignant', models.AutoField(primary_key=True, serialize=False)),
                ('mdp', models.CharField(blank=True, max_length=253, null=True, unique=True)),
                ...
                ('Service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='listings.service')),
                ('Type_personnel_soignant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='listings.type_personnel_soignant')),
