# Generated by Django 4.2.13 on 2024-07-30 00:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numeropatient', models.CharField(max_length=100, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('motifsortie', models.CharField(max_length=50)),
                ('remplipar', models.CharField(blank=True, max_length=100, null=True)),
                ('datedeces', models.DateField(blank=True, null=True)),
                ('causedudeces', models.CharField(blank=True, max_length=100, null=True)),
                ('lieudeces', models.CharField(blank=True, max_length=10, null=True)),
                ('decesliea', models.CharField(blank=True, max_length=4, null=True)),
                ('daterefus', models.DateField(blank=True, null=True)),
                ('datedernierevisite', models.DateField(blank=True, null=True)),
                ('datederniererelance', models.DateField(blank=True, null=True)),
                ...
                ('datedetransfert', models.DateField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modepaiment', models.CharField(blank=True, max_length=100, null=True)),
                ('cout_sejour', models.CharField(blank=True, max_length=100, null=True)),
                ('remboursement', models.CharField(blank=True, max_length=100, null=True)),
                ('rest_a_payer', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dyslipidemie', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('cirrhose', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('hepatiteviraleb', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('datehepvirb', models.DateField(blank=True, null=True, unique=True)),
                ('hepatiteviralec', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('datehepvirc', models.DateField(blank=True, null=True, unique=True)),
                ('hepatiteviraled', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('datehepvird', models.DateField(blank=True, null=True, unique=True)),
                ('vaccination_vhb', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('dosevhb', models.CharField(blank=True, max_length=40, null=True, unique=True)),
                ('vaccination_vha', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('dosevha', models.CharField(blank=True, max_length=40, null=True, unique=True)),
                ('transfusion_sanguine', models.CharField(choices=[('oui', 'oui'), ('non', 'non')], max_length=3, unique=True)),
                ('datransing', models.DateField(blank=True, null=True, unique=True)),
                ('ictere', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('rapportsexuelnonprotege', models.CharField(choices=[('oui', 'oui'), ('non', 'non')], max_length=3, unique=True)),
                ('partageobjettoilette', models.CharField(choices=[('oui', 'oui'), ('non', 'non')], max_length=3, unique=True)),
                ('accidexposang', models.CharField(choices=[('oui', 'oui'), ('non', 'non')], max_length=3, unique=True)),
                ('toxicomanie', models.CharField(choices=[('oui', 'oui'), ('non', 'non')], max_length=3, unique=True)),
                ('diabete', models.CharField(choices=[('oui', 'oui'), ('non', 'non')], max_length=3, unique=True)),
                ('hta', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('transplanhepatique', models.CharField(choices=[('oui', 'oui'), ('non', 'non')], max_length=3, unique=True)),
                ('precisionautre', models.CharField(blank=True, max_length=200, null=True, unique=True)),
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='listings.patient')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datederniereregle', models.DateField(blank=True, null=True, unique=True)),
                ('gestite', models.CharField(blank=True, max_length=100, null=True, unique=True)),
                ('parite', models.CharField(blank=True, max_length=100, null=True, unique=True)),
                ('prisecontraceptif', models.CharField(choices=[('oui', 'oui'), ('non', 'non')], max_length=3, unique=True)),
                ('cesarienne', models.CharField(choices=[('oui', 'oui'), ('non', 'non')], max_length=3, unique=True)),
                ('datecesarienne', models.DateField(blank=True, null=True, unique=True)),
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='listings.patient')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hepatie_vir_ASC', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('cirrhose_ASC', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('cpf_ASC', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('hepatie_vir_DSC', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('cirrhose_DSC', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('cpf_DSC', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('hepatie_vir_COL', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('cirrhose_COL', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('cpf_COL', models.CharField(choices=[('oui', 'oui'), ('non', 'non'), ('ne sait pas', 'ne sait pas')], max_length=11, unique=True)),
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='listings.patient')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operachir', models.CharField(choices=[('oui', 'oui'), ('non', 'non')], max_length=3, unique=True)),
                ('datoperachir', models.DateField(blank=True, null=True)),
                ('avp', models.CharField(choices=[('oui', 'oui'), ('non', 'non')], max_length=3, unique=True)),
                ('dateavp', models.DateField(blank=True, null=True, unique=True)),
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='listings.patient')),
            ],
        ),
