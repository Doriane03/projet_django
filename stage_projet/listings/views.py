#fromdjango.http import HttpResponse # type: ignore
#fromdjango.shortcuts import render,redirect # type: ignore
#fromdjango.contrib.auth import  login , logout, authenticate # type: ignore
#fromdjango.contrib import messages # type: ignore
#fromlistings.models  import band # type: ignore
#fromlistings.models  import listing  # type: ignore
#fromlistings.forms import contact_us # type: ignore
#fromdjango.core.mail import send_mail # type: ignore
#fromdjango.contrib.auth.hashers import make_password,check_password
#fromdjango.db.models import Subquery
#fromdjango.contrib import messages
#import des class de ma bd
#fromlistings.models import ordonnancemedicament
...
#fromlistings.models  import patient # type: ignore
...
#fromlistings.forms import personnel_soignantForm # type: ignore #pour mon modele from
#fromlistings.forms import cnx_form
#fin
